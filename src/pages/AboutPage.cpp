    ...
    : QWidget(parent)
{
    ...
    auto *details = new QLabel(
        tr("Development version 0.1.0\nQt %1\nCompiler: MSVC 2022 x64\n\n"
           "An independent extensible desktop instrumentation UI framework.\n"
           "Open-source component notices and website links will be added later.")
